...
//    Serial2.write(StrTemp,sizeof(StrTemp));  // sizeof(StrTemp) calulate strTemp length
    Serial2.write(StrTemp_write,13);  // sizeof(StrTemp) calulate strTemp length
...
void requestdata()
{
    ...
    Serial3.write(StrTemp_read,8);  // sizeof(StrTemp) calulate strTemp length
